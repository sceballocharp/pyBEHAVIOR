# pyBASIL_v3 parameters

This document describes the parameters loaded from `parameters.dat` by `pyBASIL_v3.py`, where they map in the GUI/code, when they are used, and their meaning.
